...
def plot_data(file, HOMO, LUMO):
    ...
    for i in range(LUMO,LUMO+10): # previously : for i in range(LUMO,len_data):
    ...
    plt.figure()
    ax = plt.subplot(111)
    for i in range(HOMO-10,HOMO+1): # previously : for i in range(LUMO,len_data):
